...
export function Button({
  ...
  const variant_styles = {
    ...
    secondary: "bg-secondary text-secondary-content hover:bg-secondary/90 shadow-blue-md hover:shadow-blue-lg",
    outline:
      "border border-base-300 text-base-content hover:bg-base-300 bg-transparent shadow-blue-sm hover:shadow-blue-md",
  };
